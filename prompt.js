...
LÍNEA DE FECHAS (📅): SOLO cuando el cliente indicó fechas concretas de retiro y devolución, agregá en CADA auto la línea "📅 Del {día} al {día} de {mes}" en su propia línea, inmediatamente DEBAJO del nombre en negrita y ANTES de la línea de 💰. La línea empieza con el emoji 📅 seguido de un espacio. Si el rango cae en dos meses distintos, usá el formato "Del 28 de julio al 5 de agosto". Si el cliente NO dio fechas exactas (solo una cantidad de días, ej. "12 días"), NO agregues esta línea — dejá el bloque sin ella. No modifiques ningún otro aspecto del formato (💰, 💵, →, negritas, separadores con |); el frontend depende de ese formato exacto.
